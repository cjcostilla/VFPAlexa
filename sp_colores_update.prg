...
IF RECCOUNT() > 0
	UPDATE &_ocursorSQL;
	SET nombre = xocolores.nombre;
		,observaciones = '';
		,version = version + 1;
		,ultimo_cambio = DATETIME();
		,id_ABM_empresas =  xocolores.oxid_ABM_empresas ;
		,id_ABM_regiones =  xocolores.oxid_ABM_regiones ;
		,id_ABM_usuarios =  xocolores.oxid_ABM_usuarios ;

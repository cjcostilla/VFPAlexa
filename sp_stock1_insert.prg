...
_Stock_minimo = VAL(ALLTRIM(xostock1.stminimo))
_Stock_maximo = VAL(ALLTRIM(xostock1.stmaximo))
...
INSERT INTO &_ocursorSQL (codigo;
	...
	,stock_minimo;
	,stock_maximo;
	,id_Cuentas_Contables_Compras;
	,id_Cuentas_Contables_Ventas;
	,id_Centros_de_Costo_Compras;
	,id_Centros_de_Costo_Ventas;
	,criterio_de_rotacion;
	,peso_seco;
	,peso_seco_cota_de_error;
	,peso_humedo;
	,peso_humedo_cota_de_error;
	,imagen;
	,observaciones;
	,sincronizacion;
	,VERSION;
	...
	VALUES (ALLTRIM(xostock1.codigo);
	,ALLTRIM(xostock1.detalle);
	,ALLTRIM(xostock1.ITEM);
	,_id_ABM_Rubro ;
	,_id_ABM_Subrubros ;
	...
	,_Stock_minimo ;
	,_Stock_maximo ;
	,_id_Cuentas_Contables_Compras;
	,_id_Cuentas_Contables_Ventas;
	,_id_Centros_de_Costo_Compras;
	,_id_Centros_de_Costo_Ventas;
	,EVL(xostock1.rotacion,0);
	,xostock1.peso_seco;
	,xostock1.peso_seco_error;
	,xostock1.peso_humedo;
	,xostock1.peso_humero_error;
	,ALLTRIM(xostock1.imagen);
	,ALLTRIM(xostock1.observac);
	,xostock1.num;
	,xostock1.num;
	,DATETIME();
	,DATETIME();
	,0;
	,0;
	,xostock1.oxid_ABM_empresas;
	,xostock1.oxid_ABM_regiones;
	,xostock1.oxid_ABM_usuarios;
	,xostock1.oxid_ABM_usuarios)
